...
namespace ConsoleApp3
{
    class Program
    {
        ...
        static void CheckRoom(Room[] a)
        {
            ...
            Console.WriteLine("This is a " + a[n].RoomType());
        ...
        static void CreateApartament(Room[] a)
        {
            ...
            {
                if(a[i].RoomType()=="room")
                {
                    rooms++;
                }
                if(a[i].RoomType() == "bedroom")
                {
                    bedrooms++;
                }
            }
            ...
            Console.WriteLine("This is a " + ap.kitchen.RoomType());
            ...
            {
                Console.WriteLine("This is a " + ap.room[i].RoomType());
            ...
            {
                Console.WriteLine("This is a " + ap.bedroom[i].RoomType());
